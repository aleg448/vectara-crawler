...
if [[ "${crawler_type}" == "folder" ]]; then
    ...
    echo $folder
    docker run -d -v "$folder:/home/vectara/data" -v $(pwd):/home/vectara/app -e CONFIG=/home/vectara/app/$CONFIG_FILE -e PROFILE=$PROFILE -e VECTARA_API_KEY=$VECTARA_API_KEY -e VECTARA_CORPUS_ID=$VECTARA_CORPUS_ID -e VECTARA_CUSTOMER_ID=$VECTARA_CUSTOMER_ID --name vingest $tag
    ...
    docker run -d -v "$csv_path:/home/vectara/data/file.csv" -v $(pwd):/home/vectara/app -e CONFIG=/home/vectara/app/$CONFIG_FILE -e PROFILE=$PROFILE -e VECTARA_API_KEY=$VECTARA_API_KEY -e VECTARA_CORPUS_ID=$VECTARA_CORPUS_ID -e VECTARA_CUSTOMER_ID=$VECTARA_CUSTOMER_ID --name vingest $tag
    ...
    docker run -d -v "$json_path:/home/vectara/data/file.json" -v $(pwd):/home/vectara/app -e CONFIG=/home/vectara/app/$CONFIG_FILE -e PROFILE=$PROFILE -e VECTARA_API_KEY=$VECTARA_API_KEY -e VECTARA_CORPUS_ID=$VECTARA_CORPUS_ID -e VECTARA_CUSTOMER_ID=$VECTARA_CUSTOMER_ID --name vingest $tag
else
    docker run -d -v $(pwd):/home/vectara/app -e CONFIG=/home/vectara/app/$CONFIG_FILE -e PROFILE=$PROFILE -e VECTARA_API_KEY=$VECTARA_API_KEY -e VECTARA_CORPUS_ID=$VECTARA_CORPUS_ID -e VECTARA_CUSTOMER_ID=$VECTARA_CUSTOMER_ID --name vingest $tag
fi
